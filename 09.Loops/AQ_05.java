...
// Scope of variable is referred to the part of the program where the 
// variable can be used.
// In this program variable i is declared in the for loop. So scope of variable i is 
// limited to the for loop only that is between { and } of the for loop. There is 
